                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-kas">
                                    ...
                                    <?php  
                                        ...
                                        $sql = $koneksi->query("select * from tbl_kas where jenis = 'keluar' ");
                                     ...
                                     ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="right"><?php echo"Rp. " .number_format($data['keluar']).",- "; ?></td>
                                            <td>
                            ...
                            <!-- PopUP Tambah Data -->
                                ...
                                <?php 
                                    if (isset($_POST['simpan'])) {
                                        ...
                                        $sql = $koneksi->query("insert into tbl_kas (kode, keterangan, tgl, jumlah, jenis, keluar)values('$kode','$ket','$tgl', 0 , 'keluar', '$jml')");
                                                ...
                                                <!-- Script PHP untuk Ubah / Update Data -->
                                                    <?php 
                                                        if (isset($_POST['ubah'])) {
                                                            ...
                                                            $sql = $koneksi->query("update tbl_kas set keterangan = '$ket', tgl = '$tgl', jumlah=0, jenis='keluar', keluar = '$jml' where kode = '$kode'");
                                                             if ($sql) {
                                                                ?>
                                                                    <script type="text/javascript">
